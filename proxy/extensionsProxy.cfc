...
<cfcomponent output="false">
	...
	<cffunction name="getCorbaConnectors" access="remote" output="false">
	...
	<cffunction name="deleteApplet" access="remote" output="false">
	...
	<cffunction name="setMapping" access="remote" output="false">
	...
	<cffunction name="deleteMapping" access="remote" output="false">
	...
	<cffunction name="setCustomTagPath" access="remote" output="false">
	...
	<cffunction name="deleteCFX" access="remote" output="false">
	...
	<cffunction name="getCFX" access="remote" output="false">
	...
	<cffunction name="reloadWebService" access="remote" output="false">
	...
	<cffunction name="setCPPCFX" access="remote" output="false">
	...
	<cffunction name="deleteCorbaConnector" access="remote" output="false">
	...
	<cffunction name="setJavaCFX" access="remote" output="false">
	...
	<cffunction name="getWebServices" access="remote" output="false">
	...
	<cffunction name="deleteWebService" access="remote" output="false">
	...
	<cffunction name="setUseOrb" access="remote" output="false">
	...
	<cffunction name="setCorbaConnector" access="remote" output="false">
	...
	<cffunction name="getCustomTagPaths" access="remote" output="false">
	...
	<cffunction name="getUseOrb" access="remote" output="false">
	...
	<cffunction name="deleteCustomTagPath" access="remote" output="false">
	...
	<cffunction name="setApplet" access="remote" output="false">
	...
	<cffunction name="getMappings" access="remote" output="false">
	...
	<cffunction name="getApplets" access="remote" output="false">
	...
	<cffunction name="setWebService" access="remote" output="false">
