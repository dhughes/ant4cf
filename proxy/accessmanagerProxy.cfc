...
<cfcomponent output="false">
	...
	<cffunction name="canAccessPage" access="remote" output="false">
	...
	<cffunction name="checkAdminRoles" access="remote" output="false">
	...
	<cffunction name="checkRootAdminUser" access="remote" output="false">
