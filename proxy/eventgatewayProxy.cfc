...
<cfcomponent output="false">
	...
	<cffunction name="startSMSTestServer" access="remote" output="false">
	...
	<cffunction name="getGatewayInstanceStatus" access="remote" output="false">
	...
	<cffunction name="setGatewayInstance" access="remote" output="false">
			...
			<cfargument name="adminUserId" type="any" required="false">
				...
				<cfargument name="cfcPaths" type="array" required="Yes">
	...
	<cffunction name="ResetGatewayEvents" access="remote" output="false">
	...
	<cffunction name="startGatewayInstance" access="remote" output="false">
	...
	<cffunction name="getSMSTestServerStatus" access="remote" output="false">
	...
	<cffunction name="getGatewayEvents" access="remote" output="false">
	...
	<cffunction name="getGatewayServiceStatus" access="remote" output="false">
	...
	<cffunction name="setGatewayType" access="remote" output="false">
	...
	<cffunction name="stopGatewayInstance" access="remote" output="false">
	...
	<cffunction name="deleteGatewayType" access="remote" output="false">
	...
	<cffunction name="getGatewayInstances" access="remote" output="false">
	...
	<cffunction name="setGatewayProperty" access="remote" output="false">
	...
	<cffunction name="getGatewayProperty" access="remote" output="false">
	...
	<cffunction name="getGatewayTypes" access="remote" output="false">
	...
	<cffunction name="deleteGatewayInstance" access="remote" output="false">
	...
	<cffunction name="setGatewayServiceStatus" access="remote" output="false">
	...
	<cffunction name="stopGatewayService" access="remote" output="false">
	...
	<cffunction name="stopSMSTestServer" access="remote" output="false">
	...
	<cffunction name="restartGatewayInstance" access="remote" output="false">
	...
	<cffunction name="startGatewayService" access="remote" output="false">
