...
<cfcomponent output="false">
	...
	<cffunction name="stopInstance" access="remote" output="false">
	...
	<cffunction name="startInstance" access="remote" output="false">
	...
	<cffunction name="restartInstance" access="remote" output="false">
