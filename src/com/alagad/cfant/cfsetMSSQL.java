...
public class cfsetMSSQL extends ProxyTask {
		...
		private String _sendStringParametersAsUnicode = "";
		...
		public void setsendStringParametersAsUnicode(String _sendStringParametersAsUnicode) {
			this._sendStringParametersAsUnicode = _sendStringParametersAsUnicode;
		}
	
		private String getsendStringParametersAsUnicode() {
			return this._sendStringParametersAsUnicode;
		}
	...
	public void execute() throws BuildException {
		try{
			...
			proxyUrl += "&returnformat=plain";
				...
				if(!getsendStringParametersAsUnicode().equals("")){
					proxyUrl += "&sendStringParametersAsUnicode=" + getsendStringParametersAsUnicode(); 
				}
			...
			if(Boolean.parseBoolean(debug)){
				System.out.println("Running Task 'setMSSQL' via url: " + proxyUrl);
			}
