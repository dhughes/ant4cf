...
public class cfsetMapping extends ProxyTask {
		...
		try{
			...
			proxyUrl += "&returnformat=plain";
				...
				if(!getmapName().equals("")){
					proxyUrl += "&mapName=" + getmapName(); 
				}
			
				if(!getmapPath().equals("")){
					proxyUrl += "&mapPath=" + getmapPath(); 
				}
			
			
			if(Boolean.parseBoolean(debug)){
				System.out.println("Running Task 'setMapping' via url: " + proxyUrl);
			}
