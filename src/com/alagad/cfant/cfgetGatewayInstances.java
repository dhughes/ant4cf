...
public class cfgetGatewayInstances extends ProxyTask {
	...
	public void execute() throws BuildException {
		try{
			...
			proxyUrl += "?method=getGatewayInstances";
			...
			if(Boolean.parseBoolean(debug)){
				System.out.println("Running Task 'getGatewayInstances' via url: " + proxyUrl);
			}
