...
public class cfgetDisabledDatasources extends ProxyTask {
	...
	public void execute() throws BuildException {
		try{
			...
			proxyUrl += "?method=getDisabledDatasources";
			...
			if(Boolean.parseBoolean(debug)){
				System.out.println("Running Task 'getDisabledDatasources' via url: " + proxyUrl);
			}
