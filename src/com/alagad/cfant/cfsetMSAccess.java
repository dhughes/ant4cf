...
public class cfsetMSAccess extends ProxyTask {
		...
		private String _systemDatabaseFile = "";
	
		private String _UseTrustedConnection = "";
	
		private String _defaultusername = "";
	
		private String _maxBufferSize = "";
	
		private String _pageTimeout = "";
		...
		public void setdatabasefile(String _databasefile) {
			this._databasefile = _databasefile;
		}
		...
		public void setsystemDatabaseFile(String _systemDatabaseFile) {
			this._systemDatabaseFile = _systemDatabaseFile;
		}
	
		private String getsystemDatabaseFile() {
			return this._systemDatabaseFile;
		}
	
		public void setUseTrustedConnection(String _UseTrustedConnection) {
			this._UseTrustedConnection = _UseTrustedConnection;
		}
	
		private String getUseTrustedConnection() {
			return this._UseTrustedConnection;
		}
	
		public void setdefaultusername(String _defaultusername) {
			this._defaultusername = _defaultusername;
		}
		...
		public void setmaxBufferSize(String _maxBufferSize) {
			this._maxBufferSize = _maxBufferSize;
		}
	
		private String getmaxBufferSize() {
			return this._maxBufferSize;
		}
	
		public void setpageTimeout(String _pageTimeout) {
			this._pageTimeout = _pageTimeout;
		}
	
		private String getpageTimeout() {
	...
	public void execute() throws BuildException {
		try{
			...
			proxyUrl += "&returnformat=plain";
				...
				if(!getdatabasefile().equals("")){
					proxyUrl += "&databasefile=" + getdatabasefile(); 
				}
				...
				if(!getsystemDatabaseFile().equals("")){
					proxyUrl += "&systemDatabaseFile=" + getsystemDatabaseFile(); 
				}
				...
				if(!getdefaultusername().equals("")){
					proxyUrl += "&defaultusername=" + getdefaultusername(); 
				}
			
				if(!getmaxBufferSize().equals("")){
					proxyUrl += "&maxBufferSize=" + getmaxBufferSize(); 
				}
			
				if(!getpageTimeout().equals("")){
					proxyUrl += "&pageTimeout=" + getpageTimeout(); 
				}
			...
			if(Boolean.parseBoolean(debug)){
				System.out.println("Running Task 'setMSAccess' via url: " + proxyUrl);
			}
