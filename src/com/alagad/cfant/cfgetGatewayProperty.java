...
public class cfgetGatewayProperty extends ProxyTask {
	...
	public void execute() throws BuildException {
		try{
			...
			proxyUrl += "?method=getGatewayProperty";
			...
			if(Boolean.parseBoolean(debug)){
				System.out.println("Running Task 'getGatewayProperty' via url: " + proxyUrl);
			}
