...
public class cfstartGatewayInstance extends ProxyTask {
	...
	public void execute() throws BuildException {
		try{
			...
			proxyUrl += "?method=startGatewayInstance";
			...
			if(Boolean.parseBoolean(debug)){
				System.out.println("Running Task 'startGatewayInstance' via url: " + proxyUrl);
			}
