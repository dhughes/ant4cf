...
public class cfdeleteGatewayInstance extends ProxyTask {
	...
	public void execute() throws BuildException {
		try{
			...
			proxyUrl += "?method=deleteGatewayInstance";
			...
			if(Boolean.parseBoolean(debug)){
				System.out.println("Running Task 'deleteGatewayInstance' via url: " + proxyUrl);
			}
