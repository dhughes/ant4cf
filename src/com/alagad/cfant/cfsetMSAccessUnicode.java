...
public class cfsetMSAccessUnicode extends ProxyTask {
	...
	public void execute() throws BuildException {
		try{
			...
			proxyUrl += "?method=setMSAccessUnicode";
			...
			if(Boolean.parseBoolean(debug)){
				System.out.println("Running Task 'setMSAccessUnicode' via url: " + proxyUrl);
			}
