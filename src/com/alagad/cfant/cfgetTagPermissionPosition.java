...
public class cfgetTagPermissionPosition extends ProxyTask {
	...
	public void execute() throws BuildException {
		try{
			...
			proxyUrl += "?method=getTagPermissionPosition";
			...
			if(Boolean.parseBoolean(debug)){
				System.out.println("Running Task 'getTagPermissionPosition' via url: " + proxyUrl);
			}
