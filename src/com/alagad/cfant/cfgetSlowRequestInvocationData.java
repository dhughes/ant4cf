...
public class cfgetSlowRequestInvocationData extends ProxyTask {
	...
	public void execute() throws BuildException {
		try{
			...
			proxyUrl += "?method=getSlowRequestInvocationData";
			...
			if(Boolean.parseBoolean(debug)){
				System.out.println("Running Task 'getSlowRequestInvocationData' via url: " + proxyUrl);
			}
