...
public class cfdeleteSecuredFolder extends ProxyTask {
	...
	public void execute() throws BuildException {
		try{
			...
			proxyUrl += "?method=deleteSecuredFolder";
			...
			if(Boolean.parseBoolean(debug)){
				System.out.println("Running Task 'deleteSecuredFolder' via url: " + proxyUrl);
			}
