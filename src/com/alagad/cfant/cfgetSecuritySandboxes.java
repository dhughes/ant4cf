...
public class cfgetSecuritySandboxes extends ProxyTask {
	...
	public void execute() throws BuildException {
		try{
			...
			proxyUrl += "?method=getSecuritySandboxes";
			...
			if(Boolean.parseBoolean(debug)){
				System.out.println("Running Task 'getSecuritySandboxes' via url: " + proxyUrl);
			}
