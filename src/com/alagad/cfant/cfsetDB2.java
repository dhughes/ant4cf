...
public class cfsetDB2 extends ProxyTask {
		...
		public void setinitargs(String _initargs) {
			this._initargs = _initargs;
		}
	...
	public void execute() throws BuildException {
		try{
			...
			proxyUrl += "&returnformat=plain";
				...
				if(!getinitargs().equals("")){
					proxyUrl += "&initargs=" + getinitargs(); 
				}
			...
			if(Boolean.parseBoolean(debug)){
				System.out.println("Running Task 'setDB2' via url: " + proxyUrl);
			}
