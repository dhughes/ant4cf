...
public class cfsetDisabledDatasource extends ProxyTask {
	...
	public void execute() throws BuildException {
		try{
			...
			proxyUrl += "?method=setDisabledDatasource";
			...
			if(Boolean.parseBoolean(debug)){
				System.out.println("Running Task 'setDisabledDatasource' via url: " + proxyUrl);
			}
