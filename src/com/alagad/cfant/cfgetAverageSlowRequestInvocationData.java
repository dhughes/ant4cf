...
public class cfgetAverageSlowRequestInvocationData extends ProxyTask {
	...
	public void execute() throws BuildException {
		try{
			...
			proxyUrl += "?method=getAverageSlowRequestInvocationData";
			...
			if(Boolean.parseBoolean(debug)){
				System.out.println("Running Task 'getAverageSlowRequestInvocationData' via url: " + proxyUrl);
			}
