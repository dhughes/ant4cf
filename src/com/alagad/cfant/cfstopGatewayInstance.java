...
public class cfstopGatewayInstance extends ProxyTask {
	...
	public void execute() throws BuildException {
		try{
			...
			proxyUrl += "?method=stopGatewayInstance";
			...
			if(Boolean.parseBoolean(debug)){
				System.out.println("Running Task 'stopGatewayInstance' via url: " + proxyUrl);
			}
