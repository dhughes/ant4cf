...
public class cfgetDisabledCFFunctions extends ProxyTask {
	...
	public void execute() throws BuildException {
		try{
			...
			proxyUrl += "?method=getDisabledCFFunctions";
			...
			if(Boolean.parseBoolean(debug)){
				System.out.println("Running Task 'getDisabledCFFunctions' via url: " + proxyUrl);
			}
