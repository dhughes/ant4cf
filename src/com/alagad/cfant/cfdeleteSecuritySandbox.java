...
public class cfdeleteSecuritySandbox extends ProxyTask {
	...
	public void execute() throws BuildException {
		try{
			...
			proxyUrl += "?method=deleteSecuritySandbox";
			...
			if(Boolean.parseBoolean(debug)){
				System.out.println("Running Task 'deleteSecuritySandbox' via url: " + proxyUrl);
			}
