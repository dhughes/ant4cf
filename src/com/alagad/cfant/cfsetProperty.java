...
public class cfsetProperty extends ProxyTask {
	...
	public void execute() throws BuildException {
		try{
			...
			proxyUrl += "/proxy/flexProxy.cfc";
			proxyUrl += "?method=setProperty";
			...
			if(Boolean.parseBoolean(debug)){
				System.out.println("Running Task 'setProperty' via url: " + proxyUrl);
			}
