...
public class cfdeleteUserSnapshot extends ProxyTask {
		...
		public void setsnapshotFilePath(String _snapshotFilePath) {
			this._snapshotFilePath = _snapshotFilePath;
		}
	...
	public void execute() throws BuildException {
		try{
			...
			proxyUrl += "?method=deleteUserSnapshot";
