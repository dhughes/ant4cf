...
public class cfdeleteDisabledCFFunction extends ProxyTask {
	...
	public void execute() throws BuildException {
		try{
			...
			proxyUrl += "?method=deleteDisabledCFFunction";
			...
			if(Boolean.parseBoolean(debug)){
				System.out.println("Running Task 'deleteDisabledCFFunction' via url: " + proxyUrl);
			}
