...
public class cfrestartGatewayInstance extends ProxyTask {
	...
	public void execute() throws BuildException {
		try{
			...
			proxyUrl += "?method=restartGatewayInstance";
			...
			if(Boolean.parseBoolean(debug)){
				System.out.println("Running Task 'restartGatewayInstance' via url: " + proxyUrl);
			}
